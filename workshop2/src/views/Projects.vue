<template>
    <div class="projects">
        ...
        <div class="bg-dark d-flex justify-content-between pt-2">
            <p class="ms-5 text-white"> &#169; workshop 2 &#62; Sprint 3 <a href="https://github.com/AbdelmounaimBakkari">Here</a></p>
            <div class="me-5">ICON</div>
        </div>
    </div>
</template>
...
.sign{
    ...
    &.s-software{
        border: 4px solid #E0102B;
    }

    &.s-library{
        border: 4px solid #0093EE;
    }

    &.s-game{
        border: 4px solid #AB7EF6;
    }

    &.s-script{
        border: 4px solid #96BF47;
    }

    &.s-website{
        border: 4px solid #FFB610;
    }
}
